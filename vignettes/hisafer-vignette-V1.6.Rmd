...
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "carbon", years = 2022)
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "nitrogen", years = 2022)
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "water", years = 2022)
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "light", years = 2022)
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "carbon-increment", years = 2022)
```
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_ts(hop = hop, cycle = "carbon-allocation", years = 2022)
```
...
```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_bar(hop = hop, cycle = "water", freq = "month", years = 2022)
```

```{r, eval = TRUE, dpi = 250, fig.width = 10}
plot_hisafe_cycle_bar(hop = hop, cycle = "water", freq = "day", years = 2022, months = 4:5)
```
